...
# FIXME stub
class odf_presentation_page_layout_style(odf_style):

    def get_style_family(self):
        return 'presentation_page_layout'
...
register_element_class('style:presentation-page-layout', odf_presentation_page_layout_style)
